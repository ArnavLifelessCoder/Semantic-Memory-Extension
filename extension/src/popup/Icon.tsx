/**
 * Monochrome line-icon set (24x24, stroke = currentColor).
 * Replaces emoji throughout the UI for a consistent, product-grade look.
 */
...
const PATHS: Record<IconName, React.ReactNode> = {
  logo: (
    <>
      <path d="M12 3a4 4 0 0 0-4 4 3 3 0 0 0-1 5.83V15a3 3 0 0 0 5 2.24" />
      <path d="M12 3a4 4 0 0 1 4 4 3 3 0 0 1 1 5.83V15a3 3 0 0 1-5 2.24" />
      <path d="M12 7v10" />
    </>
  ),
  search: (
